  ...
  <div class="welfare-wrapper">
    ...
    <div class="content-container">
      <div style="padding-bottom: 10px; display: flex; align-items: center; justify-content: space-between">
        ...
        <van-button class="action-btn" style="width:3rem;height: 0.68rem;min-width:80px" @click="$parent.goNav('/hongbao')"><span style="color: #fff; font-size: 0.3rem">前往领取</span></van-button>
      </div>
