...
<body id="page-top">
  <!-- Page Wrapper -->
  <div id="wrapper">
    <?php echo $__env->make('agent.layouts.aside', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div id="content-wrapper" class="d-flex flex-column">

      <!-- Main Content -->
      <div id="content">
        <?php echo $__env->make('agent.layouts.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo e(url('/logout'), false); ?>">
                        退出
                    </a>
                </div>
            </div>
    ...
    <div class="modal fade" id="opMsgModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo e(session('opMsg'), false); ?>
...
<?php /**PATH D:\www\xingyun\admin\resources\views/agent/layouts/agent_template.blade.php ENDPATH**/ ?>