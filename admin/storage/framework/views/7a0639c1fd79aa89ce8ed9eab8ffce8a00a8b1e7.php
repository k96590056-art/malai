            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="mt-4a text-center small">
                        ...
                        <span class="mr-2">刷新时间：<?php echo e(date('Y-m-d H:i:s'), false); ?></span>
                    </div>
...
<?php echo $__env->make('agent.layouts.agent_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/admin/resources/views/agent/report/chart.blade.php ENDPATH**/ ?>